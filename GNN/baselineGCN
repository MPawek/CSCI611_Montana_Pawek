...
# Initial GCN model with no added features
...
# Cuda is necessary for improving training time
DEVICE = torch.device("cuda" if torch.cuda.is_available() else "cpu")

# CSV Loading 
# This is mostly borrowed from CSV loading examples on Github
